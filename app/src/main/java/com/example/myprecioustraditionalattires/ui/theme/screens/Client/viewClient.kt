...
import com.example.myprecioustraditionalattires.navigation.ROUTE_UPDATE_CLIENT
...
fun ViewClients(navController: NavHostController){
    ...
    val emptyUploadState = remember {
        mutableStateOf(com.example.myprecioustraditionalattires.models.Client("",
            "","","","",""))
    }
    val emptyUploadListState = remember {
        mutableStateListOf<com.example.myprecioustraditionalattires.models.Client>()
    }
